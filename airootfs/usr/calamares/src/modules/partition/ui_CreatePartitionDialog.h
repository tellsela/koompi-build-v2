...
public:
    ...
    {
        CreatePartitionDialog->setWindowTitle(QApplication::translate("CreatePartitionDialog", "Create a Partition", nullptr));
        label->setText(QApplication::translate("CreatePartitionDialog", "Si&ze:", nullptr));
        sizeSpinBox->setSuffix(QApplication::translate("CreatePartitionDialog", " MiB", nullptr));
        partitionTypeLabel->setText(QApplication::translate("CreatePartitionDialog", "Partition &Type:", nullptr));
        primaryRadioButton->setText(QApplication::translate("CreatePartitionDialog", "&Primary", nullptr));
        extendedRadioButton->setText(QApplication::translate("CreatePartitionDialog", "E&xtended", nullptr));
        label_2->setText(QApplication::translate("CreatePartitionDialog", "Fi&le System:", nullptr));
        lvNameLabel->setText(QApplication::translate("CreatePartitionDialog", "LVM LV name", nullptr));
        mountPointLabel->setText(QApplication::translate("CreatePartitionDialog", "&Mount Point:", nullptr));
        labelMountPoint->setText(QString());
        label_3->setText(QApplication::translate("CreatePartitionDialog", "Flags:", nullptr));
    } // retranslateUi
