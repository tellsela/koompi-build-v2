...
public:
    ...
    {
        Calamares__DebugWindow->setWindowTitle(QApplication::translate("Calamares::DebugWindow", "Form", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(globalStorageTab), QApplication::translate("Calamares::DebugWindow", "GlobalStorage", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(jobQueueTab), QApplication::translate("Calamares::DebugWindow", "JobQueue", nullptr));
        label->setText(QApplication::translate("Calamares::DebugWindow", "Type:", nullptr));
        moduleTypeLabel->setText(QApplication::translate("Calamares::DebugWindow", "none", nullptr));
        label_2->setText(QApplication::translate("Calamares::DebugWindow", "Interface:", nullptr));
        moduleInterfaceLabel->setText(QApplication::translate("Calamares::DebugWindow", "none", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(modulesTab), QApplication::translate("Calamares::DebugWindow", "Modules", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(toolsTab), QApplication::translate("Calamares::DebugWindow", "Tools", nullptr));
    } // retranslateUi
