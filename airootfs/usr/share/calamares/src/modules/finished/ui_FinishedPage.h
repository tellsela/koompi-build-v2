...
public:
    ...
    {
        FinishedPage->setWindowTitle(QApplication::translate("FinishedPage", "Form", nullptr));
#ifndef QT_NO_TOOLTIP
        restartCheckBox->setToolTip(QApplication::translate("FinishedPage", "<html><head/><body><p>When this box is checked, your system will restart immediately when you click on <span style=\" font-style:italic;\">Done</span> or close the installer.</p></body></html>", nullptr));
#endif // QT_NO_TOOLTIP
        restartCheckBox->setText(QApplication::translate("FinishedPage", "&Restart now", nullptr));
    } // retranslateUi
