...
QT_MOC_LITERAL(1, 15, 10), // "checkReady"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 10), // "dataIsHere"
QT_MOC_LITERAL(4, 38, 14) // "QNetworkReply*"

    },
    "NetInstallPage\0checkReady\0\0dataIsHere\0"
    "QNetworkReply*"
};
...
void NetInstallPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->dataIsHere((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (NetInstallPage::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetInstallPage::checkReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NetInstallPage::checkReady(bool _t1)
{
