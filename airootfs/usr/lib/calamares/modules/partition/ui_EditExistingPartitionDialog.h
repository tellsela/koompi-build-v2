...
public:
    ...
    {
        EditExistingPartitionDialog->setWindowTitle(QApplication::translate("EditExistingPartitionDialog", "Edit Existing Partition", nullptr));
        label_3->setText(QApplication::translate("EditExistingPartitionDialog", "Content:", nullptr));
        keepRadioButton->setText(QApplication::translate("EditExistingPartitionDialog", "&Keep", nullptr));
        formatRadioButton->setText(QApplication::translate("EditExistingPartitionDialog", "Format", nullptr));
        label_2->setText(QApplication::translate("EditExistingPartitionDialog", "Warning: Formatting the partition will erase all existing data.", nullptr));
        mountPointLabel->setText(QApplication::translate("EditExistingPartitionDialog", "&Mount Point:", nullptr));
        label->setText(QApplication::translate("EditExistingPartitionDialog", "Si&ze:", nullptr));
        sizeSpinBox->setSuffix(QApplication::translate("EditExistingPartitionDialog", " MiB", nullptr));
        fileSystemLabel->setText(QApplication::translate("EditExistingPartitionDialog", "Fi&le System:", nullptr));
        label_4->setText(QApplication::translate("EditExistingPartitionDialog", "Flags:", nullptr));
