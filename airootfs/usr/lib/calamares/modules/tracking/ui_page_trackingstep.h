...
"margin-left: 2em;"));
        ...
        noneRadio = new QRadioButton(noneGroup);
        noneRadio->setObjectName(QString::fromUtf8("noneRadio"));

        noneLayout->addWidget(noneRadio);
        ...
        installRadio = new QRadioButton(installGroup);
        installRadio->setObjectName(QString::fromUtf8("installRadio"));

        installLayout->addWidget(installRadio);
        ...
        machineRadio = new QRadioButton(machineGroup);
        machineRadio->setObjectName(QString::fromUtf8("machineRadio"));

        machineLayout->addWidget(machineRadio);
        ...
        userRadio = new QRadioButton(userGroup);
        userRadio->setObjectName(QString::fromUtf8("userRadio"));

        userLayout->addWidget(userRadio);
    ...
    {
        TrackingPage->setWindowTitle(QApplication::translate("TrackingPage", "Form", nullptr));
        generalExplanation->setText(QApplication::translate("TrackingPage", "Placeholder", nullptr));
        noneRadio->setText(QString());
        noneIcon->setText(QString());
        noneExplanation->setText(QApplication::translate("TrackingPage", "<html><head/><body><p>By selecting this, you will send <span style=\" font-weight:600;\">no information at all</span> about your installation.</p></body></html>", nullptr));
        installRadio->setText(QString());
        installIcon->setText(QString());
        installExplanation->setText(QApplication::translate("TrackingPage", "TextLabel", nullptr));
        installPolicyButton->setText(QApplication::translate("TrackingPage", "...", nullptr));
        machineRadio->setText(QString());
        machineIcon->setText(QString());
        machineExplanation->setText(QApplication::translate("TrackingPage", "TextLabel", nullptr));
        machinePolicyButton->setText(QApplication::translate("TrackingPage", "...", nullptr));
        userRadio->setText(QString());
        userIcon->setText(QString());
        userExplanation->setText(QApplication::translate("TrackingPage", "TextLabel", nullptr));
        userPolicyButton->setText(QApplication::translate("TrackingPage", "...", nullptr));
        generalPolicyLabel->setText(QApplication::translate("TrackingPage", "<html><head/><body><p><a href=\"placeholder\"><span style=\" text-decoration: underline; color:#2980b9;\">Click here for more information about user feedback</span></a></p></body></html>", nullptr));
    } // retranslateUi
